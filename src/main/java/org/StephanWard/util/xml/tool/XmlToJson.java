...
public class XmlToJson {
    ...
    public static class Builder {
        ...
        private HashMap<String, Class<?>> mForceClassForPath = new HashMap<String, Class<?>>();    // Integer, Long, Double, Boolean
        ...
        try {
            ...
            do {
                ...
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    Logger.getGlobal().info("unknown xml eventType " + eventType);
                }
    ...
    /**
     * Format the Json with indentation and line breaks.
     * Uses the last indentation pattern used, or the default one (3 spaces)
     *
     * @return the Builder
     */
