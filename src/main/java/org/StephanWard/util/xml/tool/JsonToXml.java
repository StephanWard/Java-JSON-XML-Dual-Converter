...
public class JsonToXml {
    ...
    public String toFormattedString(Integer indent) {
    	...
    	/*
         * The indent type is modified to the packaging type Integer type, if it is empty, it is the default value.
    	 * @author Stephan Ward
    	 * @since 08/25/2021
    	 */
    	if(indent == null){
    	...
    	try {
            ...
            /*
             * When outputting in "xml" mode, whether to omit the <?xml version="1.0" encoding="utf-8" standalone="no"?> header information.
             * @author Stephan Ward
             */
            //transformer.setOutputProperty(OutputKeys.OMIT_XML_DECLARATION, "yes");

            /*
             * Output in "HTML" mode, you can also omit the <?xml version="1.0" encoding="utf-8" standalone="no"?> header information.
             * @author Stephan Ward
             */
            ...
            /*
             * Set line break and indent
             * You must set the OutputKeys.INDENT property value to "yes" when setting the indent.
    		 * @author Stephan Ward
    		 */
    ...
    private String nodeToXML(Node node) {
        ...
        try {
            ...
            /*
             * Control whether the Xml string returned by the toString() method has header information.
             * Note: Whether the Xml string returned by the toFormattedString() and toFormattedString(...) methods has header information is not controlled here.
             * @author Stephan Ward
             */
